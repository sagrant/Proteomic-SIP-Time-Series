...
########## COMPARE LABELED PROTEOME AND UNLABELED PROTEOME
...
### CLR-TRANSFORM LABELED PROTEOME
...
rownames(labeledPERMANOVAMetadata.taxon.clr.cecum) <- labeledPhyloseqObj.taxon.clr.cecum@sam_data@row.names 
colnames(labeledPERMANOVAMetadata.taxon.clr.cecum) <- labeledPhyloseqObj.taxon.clr.cecum@sam_data@names 
...
rownames(unlabeledPERMANOVAMetadata.taxon.clr.cecum) <- unlabeledPhyloseqObj.taxon.clr.cecum@sam_data@row.names
colnames(unlabeledPERMANOVAMetadata.taxon.clr.cecum) <- unlabeledPhyloseqObj.taxon.clr.cecum@sam_data@names
