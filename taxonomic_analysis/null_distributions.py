...
class nullDistributions():
    ...
    def chooseTaxa(self, df):
        ...
        Notes
        -----
        Returning gb.index.tolist() instead of abundantGenera will result
        in plotting null distributions for all signifcantly labeled genera
        instead of just the signficantly labeled genera of those that are 
